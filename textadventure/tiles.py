...
class EnemyRoom(MapTile):
	...
	def modify_player(self, the_player):
		if self.enemy.is_alive():
			...
			print ("Enemy does {} damage. You have {} HP remainin.".format(self.enemy.damage, the_player.hp))
...
class OgreRoom(EnemyRoom):
	...
	def intro_text(self):
		if self.enemy.is_alive():
			return """An enormous lumbering Ogre looms in front of you!"""
		else:
			return """A solitary Ogre lays slain in front of you."""
...
class FindDaggerRoom(LootRoom):
	...
	def intro_text(self):
		return """You notice something shiny in the corner. It's a dagger! You pick it up."""

class FindGoldRoom(LootRoom):
	def __init__(self, x, y):
		super(5).__init__(x, y, items.Gold())

	def intro_text(self):
		return """A glint of light catches your eye. You move closer to find a dusty golden coin laying in the rubble."""
